...
$chambre2 = new Chambre ($hotel1, 2, 120, true, true);
$chambre3 = new Chambre ($hotel1, 3, 130, false, true);
$chambre4 = new Chambre ($hotel1, 4, 140, false, true);
$chambre5 = new Chambre ($hotel2, 1, 150, false, true);
$chambre6 = new Chambre ($hotel2, 2, 160, false, true);
$chambre7 = new Chambre ($hotel2, 3, 170, true, true);
$chambre8 = new Chambre ($hotel2, 4, 180, true, true);
...
function afficherChambreHTML($hotel) {
    $result = "Statuts des chambres de <strong>".$hotel->getNom()." ".$hotel->getVille()."</strong><br>";
    $result .= "
    <style>
    table {
